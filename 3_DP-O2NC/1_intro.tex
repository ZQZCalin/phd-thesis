...
% We further construct a variance-reduced gradient oracle using these estimators and incorporate the tree mechanism to reduce the amount of noise required to achieve the desired privacy guarantees. This design yields an optimal privacy guarantee. A detailed explanation of the intuition and challenges associated with our algorithm can be found in Section \ref{sec:DP-O2NC_algorithm}.
...
More details about the intuitions and challenges of our algorithm can be found in Section \ref{sec:DP-O2NC_algorithm}.