...
Online learning has deep connections to optimization. When the loss functions $\ell_t$ are convex, many classical algorithms for online learning can be interpreted as variants of gradient-based optimization methods applied in an incremental manner. For example, online gradient descent updates the decision according to
\begin{equation}
