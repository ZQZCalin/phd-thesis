...
\begin{align*}
    \calA_i:(\vecx_1,\ldots,\vecx_{i-1},\calZ_T) \mapsto \sum_{j=a}^i \calM_j(\vecx_1,\ldots,\vecx_{j-1},\calZ_T),
\end{align*}
we establish that 
\begin{align*}
...
Let $\tilde\calA_i = \calA_i + \vecr_i$, where $\vecr_i\sim\calR_i$ independently. 

% TODO: complete the proof: use general distribution \calR_i that makes \calA_i RDP.
