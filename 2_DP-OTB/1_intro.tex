...
If $\E[\calR]=0$ and $\E[\|\calR\|^2]=1$, and $\|\cdot\|_\ast^2$ is $\lambda$-strongly convex with respect to $\|\cdot\|_\ast$, then
\begin{equation}
    \E[\|\tree(k)\|^2] \le \frac{2\log_2(2k)}{\lambda}\max_{i\le k} \sigma_i^2.
