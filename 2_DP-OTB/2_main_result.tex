...
\end{align*}
In the second line, the first term is bounded by Lipschitzness, the second term follows from \eqref{eq:DP-OTB:variance-norm}, and the third is bounded by the combination of \eqref{thm:tree-mechanism:noise} and \eqref{eq:DP-OTB:RDP-noise}, namely
\begin{equation}
