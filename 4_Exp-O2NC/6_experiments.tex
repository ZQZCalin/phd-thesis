...
For each optimizer, we ran the experiment three times under the same setting to minimize variability. We recorded the train loss, train accuracy, test loss, and test accuracy (refer to Figure \ref{fig:Exp-O2NC:experiment}). We also recorded the performance of the best iterate, e.g., the lowest train/test loss and the highest train/test accuracy, in each trial (see Table \ref{tab:Exp-O2NC:1}).

\begin{table}[h]
\caption{Performance of the best iterate in each trial.}
\label{tab:Exp-O2NC:1}
\vskip 0.15in
\begin{center}
\begin{small}
\begin{sc}
