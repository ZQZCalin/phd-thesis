...
\end{align*}
Next, assume $F$ is $\rho$-second-order smooth. By Taylor approximation, there exists some $\vecz$ such that $\nabla F(\vecx) = \nabla F(\vecy) + \nabla^2F(\vecx)(\vecx-\vecy) + \frac{1}{2}(\vecx-\vecy)^T\nabla^3F(\vecz)(\vecx-\vecy)$. Note that $\E[\nabla^2F(\vecx)(\vecx-\vecy)]=\nabla^2F(\vecx)\E[\vecx-\vecy]=0$. Consequently,
\begin{align*}
    \|\nabla F(\vecx)\|
    &\le \|\E\nabla F(\vecy)\| + \|\E[\nabla F(\vecx)-\nabla F(\vecy)]\| \\
    &\le \|\E\nabla F(\vecy)\| + \E\|\tfrac{1}{2}(\vecx-\vecy)^T\nabla^3F(\vecz)(\vecx-\vecy)\| \tag{Jensen's inequality}\\
