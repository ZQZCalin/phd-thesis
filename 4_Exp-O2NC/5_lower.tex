...
\label{sec:Exp-O2NC_lower}

% \begin{remark}
In this section we leverage Lemma~\ref{lem:Exp-O2NC:criterion-reduction} to build a lower bound for finding  $(c,\epsilon)$-stationary points. Inuitively, Lemma~\ref{lem:Exp-O2NC:criterion-reduction} suggests that $O(c^{1/2}\epsilon^{-7/2})$ is the optimal rate for finding $(c,\epsilon)$-stationary point. We can indeed prove its optimality using the lower bound construction by \citet{arjevani2019lower} and \citet{cutkosky2023optimal}.
